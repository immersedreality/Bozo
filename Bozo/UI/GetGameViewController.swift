...
class GetGameViewController: UIViewController {
    ...
    private func configureSegmentedControls() {
        playerCountSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.white], for: .normal)
        playerCountSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.white], for: .selected)
        gameLengthSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.white], for: .normal)
        gameLengthSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.white], for: .selected)
        minRatingSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.white], for: .normal)
        minRatingSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.white], for: .selected)
        maxPlaysSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.white], for: .normal)
        maxPlaysSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.white], for: .selected)
        bestRankedSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.white], for: .normal)
        bestRankedSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.white], for: .selected)
    }
    ...
    @IBAction func getGameTapped(_ sender: UIButton) {
        guard playerCountSegmentedControl.selectedSegmentIndex != UISegmentedControl.noSegment &&
            gameLengthSegmentedControl.selectedSegmentIndex != UISegmentedControl.noSegment &&
            minRatingSegmentedControl.selectedSegmentIndex != UISegmentedControl.noSegment &&
            maxPlaysSegmentedControl.selectedSegmentIndex != UISegmentedControl.noSegment &&
            bestRankedSegmentedControl.selectedSegmentIndex != UISegmentedControl.noSegment else {
