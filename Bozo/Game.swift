...
final class Game {
    ...
    init(id: String, title: String, yearPublished: String, imageURL: String, userRating: Int?, minimumPlayTime: Int, maximumPlayTime: Int, geekRating: Double, plays: Int, suggestedPlayerCounts: [Int]?, minPlayerCount: Int, maxPlayerCount: Int) {
        self.id = id
        self.title = title
